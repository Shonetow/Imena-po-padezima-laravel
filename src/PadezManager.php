...
class PadezManager
{
     ...
     * @var array
     */
    protected $female_exceptions;
    protected $male_exceptions;
    protected $config;

    public function __construct()
    {
        $this->config            = config('padezi');
        $this->zensko            = $this->config['zensko'];
        $this->musko             = $this->config['musko'];
        $this->female_exceptions = $this->config['izuzeci_zenskih'];
        $this->male_exceptions   = $this->config['izuzeci_muskih'];
    }
    ...
    protected $num_err = 0;
    /**
     * PadezManager constructor.
     *
     * @param mixed $zensko
     * @param int $musko
     * @param array $female_exceptions
     * @param array $male_exceptions
     */
